...
(function() {
  ...
  function initKnob() {
    ...
    var knobLoaderOptions4 = {
      width: "50%", // responsive
      displayInput: true,
      fgColor: APP_COLORS["warning"]
    };
    $("#knob-chart4").knob(knobLoaderOptions4);

    var knobLoaderOptions5 = {
      width: "50%", // responsive
      displayInput: true,
      fgColor: APP_COLORS["danger"]
    };
    $("#knob-chart5").knob(knobLoaderOptions5);
    var knobLoaderOptions6 = {
      width: "50%", // responsive
      displayInput: true,
      fgColor: APP_COLORS["success"]
    };
    $("#knob-chart6").knob(knobLoaderOptions6);
    var knobLoaderOptions7 = {
      width: "50%", // responsive
      displayInput: true,
      fgColor: APP_COLORS["primary"]
    };
    $("#knob-chart7").knob(knobLoaderOptions7);
    var knobLoaderOptions8 = {
      width: "50%", // responsive
      displayInput: true,
      fgColor: APP_COLORS["secondary"]
    };
    $("#knob-chart8").knob(knobLoaderOptions8);
  }
})();
// Chart JS
// -----------------------------------
